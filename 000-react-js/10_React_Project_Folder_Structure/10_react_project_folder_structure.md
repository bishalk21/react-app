...
import React from "react";
import ReactDOM from "react-dom";
import BishalImage from "./images";
...
> There is no strict way to use a single folder structure or file naming in React project. Most of the time, these kind of choice can be made by a team. Sometimes a company may have a developed guidelines about what code conventions to follow, folder structure and file naming. There is no right or wrong way of structuring a React project but some structures are better than the others for scalability,maintainability, ease of working on files and easy to understand structure.

2. How do you export file

> We can export file in two ways. First one is by using export default and second one is by using export. If we use export default we can import the file without using curly braces. If we use export we have to use curly braces to import the file.

3. What is the difference between export default and export

> export default is used to export a single class, function or primitive from a module. export is used to export more than one thing from a module.

3. How do you import file

> We can import file in two ways. First one is by using import and second one is by using require. If we use import we can import the file without using curly braces. If we use require we have to use curly braces to import the file.
    ...
    <main>
      <div className="main-wrapper">
        <p>
          ...
          voluptates, quae, quod, voluptatibus quibusdam voluptatem
          necessitatibus quia voluptatum quidem quos natus. Quisquam, quae
          voluptate. Quisquam, quae, quod, voluptatibus quibusdam voluptatem
          necessitatibus quia voluptatum quidem quos natus. Quisquam, quae
          voluptate.
        </p>
      </div>
...
const Footer = () => {
  return (
    <footer>
      <div className="footer-wrapper">
        <p>30 Days of React Challenge</p>
      </div>
    </footer>
  );
};
